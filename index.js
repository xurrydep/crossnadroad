...
class River{
    constructor(){
        ...
        let side = new THREE.Mesh(THREE.BufferGeometryUtils.mergeBufferGeometries([leftRiverGeo, rightRiverGeo]), new THREE.MeshPhongMaterial({color: 0x8a2be2}));
        this.model.add(side);
...
class Car{
    constructor(color, size = {x: 0.95, y: 0.9, z: 0.8}){
        ...
        let carTextGeometry = new THREE.PlaneBufferGeometry(1.5, 0.4);
...
class Truck{
    constructor(color, size = {x: 0.95, y: 1, z: 1}){
        ...
        logoLoader.load('assets/images/monad.png', (logoTexture) => {
            ...
            let logoGeometry = new THREE.PlaneBufferGeometry(0.8, 0.8);
        ...
        let textGeometry = new THREE.PlaneBufferGeometry(2.2, 0.55);
